...
public class T265FormActivity extends Activity {
    ...
    class NodeListAdapter extends BaseExpandableListAdapter {
        TextView getTextView() {
            ...
            TextView textView = new TextView(T265FormActivity.this);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            LinearLayout ll = new LinearLayout(T265FormActivity.this);
        ...
        public View getChildView(final int groupPosition,final int childPosition,
            ...
            ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(T265FormActivity.this,DetailActivity.class);
